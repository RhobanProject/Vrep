...
void LUA_GETDATA_CALLBACK(SLuaCallBack* p)
{
	...
	else
	{
		...
		p->outputInt=(simInt*)simCreateBuffer(4*sizeof(int)); // 4 int return value (3 for the axes + 1 for the buttons)
...
{ // This is called just once, at the start of V-REP
	...
	simRegisterCustomLuaFunction(LUA_GETDATA,strConCat("table_3 axes, number buttons=",LUA_GETDATA,"(number deviceIndex)"),inArgs2,LUA_GETDATA_CALLBACK);
